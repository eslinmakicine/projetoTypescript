...
var avaliacao = 4.5;
//String
var nome = 'Éslin Makicine';
//Array
var idades = [23, 26, 30];
var nomes = ['éslin', 'ketlyn', 'elsa'];
var idades2 = [23, 31, 50]; //esse é outra forma de escrever da mesma forma que foi escrito na variavel "idade"
//Tuple
//ele define a quantidade de posições e o tipo de cada um. É utilizado quando esses itens são bem definidos
var jogadores; //foi escolhida o tipo de variavel "let" pois o valor será alterado. Const não permite isso
...
var retornoDaAPI = [123, 'Maicon', false];
var retornoDaAPI2 = { //nao colocou nenhum tipo de any, igual acima que foi any[]
